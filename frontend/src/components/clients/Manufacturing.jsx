...
const reviews = [
  {
    quote:
      "The quality and finish of the apparel were excellent. The entire process was smooth and the final products matched our requirements perfectly.",
    name: "Client Name",
  ...
  },
  {
    ...
    name: "Client Name",
    company: "Industrial Brand",
  },
];

export default function ManufacturingClients() {
  return (
    <section
